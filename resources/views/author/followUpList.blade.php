                        ...
                        <tr>
                          ...
                          <td><img src="{{asset('img_student/'.$student->picture)}}" width="40" style="border-radius: 25px;" height="40" alt="User" /></td>
                            ...
                            <td>
                              ...
                              <p class="text-success">Dont have tutor</p>
                                  
                              @else
                                  <p class="text-success">{{$student->User['first_name']}}. {{ $student->User['last_name']}}</p>
                       ...
                       <p class="text-danger">follow up</p>
                        ...
                        @endif
                                ...
                                <td class="text-primary" style="cursor:pointer">
                                      ...
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                              <form method="POST" action= "{{route('author.addComment', $student->id)}}">
                                                  @csrf
                                  ...
                                  <a href="{{route('author.comment',$student->id)}}"><span class="material-icons">more_horiz </span></a>
