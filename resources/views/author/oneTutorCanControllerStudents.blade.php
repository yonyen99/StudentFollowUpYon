...
<div class="main-panel">
    <div class="content">
         <div class="container-fluid">
          <h3 class="text-center">List the student that tutor control<span class="badge badge-primary">{{$countStudents}}</span></h3>
                  ...
                  @foreach ($students  as $student)
                        <tr>
                          ...
                          <td>
                            ...
                            @if ($student->status == 0)
                            <p class="text-success">Normal student</p>
