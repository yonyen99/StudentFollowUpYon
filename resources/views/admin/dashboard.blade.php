                ...
                <tbody>
                    @foreach ($students  as $student)
                        ...
                        @endif
                            @if ($student->status == 2)
                            <div class="dropdown">
                                <a class="text-primary dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-expanded="true">Archive</a>                            
                                <ul class="dropdown-menu">
                                  <a href="{{ route('admin.followUp',$student->id) }}">follow up</a>
                                </ul>  
                            </div>
                   ...
                   <div class="modal-dialog" role="document">
                     <div class="modal-content">
                       ...
                       <div class="modal-footer">
                                ...
                                <a class="text-primary" tabindex="-1" type="button" data-toggle="modal" data-backdrop="false" aria-hidden="true" data-target="#Modaldeltail{{$student->id}}" href="#"><i class="material-icons green">visibility</i></a>
                                <!-- Modal -->
                                <div class="modal fade modal-open" id="Modaldeltail{{$student->id}}" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                            ...
                                            <div class="row d-flex justify-content-center">
                                              ...
                                              <div class="row d-flex justify-content-between">
                                                ...
                                                <p>
                                                  ...
                                                  <strong class="text-info">Not yet tutor</strong> 
                                                  @else
